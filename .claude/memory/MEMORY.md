...
- [The foundation review and the eye-pairs build](eye-pairs-build-2026-09-17.md) — Kent picked the yardstick (F4); `tools/eye_pairs` built in one session. The worktree guard's command grammar; `uncovered_wanted_mm2` is a DENOMINATOR; spike the plan's APIs first
