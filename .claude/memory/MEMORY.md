...
- [Tooling research, and the chaining gate that was already met](tooling-research-and-the-chaining-gate-2026-09-13.md) — no repo/MCP/plugin improves digitizing; vendors publish NO trim distance rule; Embird's 2-3 mm inset contradicts our 0.75; card block 7 is drafted, NOT built
