...
- [Photo edit tail 2026-09-17](photo-edit-tail-2026-09-17.md) — a stale code-comment number scoped a whole task; `fill_travel_under_cover` is ~58% of a photo's edit tail; the fill-reorder memo is exact ONLY while both reorders stay pure. Read before any digitizer perf work
