...
A browser-only, beginner-first embroidery tool (21 satin fonts, quick-start templates, letter spacing, printable PDF worksheet, MULTI-ELEMENT designs, ARC/curved + multi-line text, PNG export): pick what you're making → add
