...
3. Whether Becker-class sources (under the resolution floor, upscaled) are
   ...
   400 px rung's rectangles; Kent flipped `subpixel_edges_upscaled` ON that
   day with Becker's 100 mm tier flip on the table. DECIDED.**
